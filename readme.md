...
- `max_power` и `torque` сильно связаны друг с другом (0.74).
---
...
Я построила полный пайплайн: от анализа и очистки данных до двух работающих сервисов  FastAPI  и Streamlit. Модель объясняет около 57–60% разброса цен и даёт приемлемую точность для каждого четвёртого автомобиля. Главные факторы стоимости это мощность, год выпуска и крутящий момент.
